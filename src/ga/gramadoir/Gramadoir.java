...
public class Gramadoir {
    ...
    public String getEolas() {
        ...
        try {
            ...
            if(isWindows){
              try {
                  message = new String(message.getBytes(), "Cp850");
    ...
    private Process run(String sentence){
        ...
        command.add("bash");
        command.add("-c");
        command.add("echo \"" +sentence+ "\" | "+ executable +" --api --moltai --ionchod=utf-8 --aschod=utf-8 --comheadan=\"" + lang + "\"");
    ...
    private ArrayList<SingleProofreadingError> getErrorsFromPerl(String sentence) {
        ...
        if( isWindows )
            ...
            //getGramadoirResults gGR = new getGramadoirResults(p, errors);
            //gGR.start();
        String output="";
        InputStreamReader isr = new InputStreamReader(p.getInputStream());
        BufferedReader br = new BufferedReader(isr);
...
//                break;
    ...
    public String insertLinebreaks(String str){
